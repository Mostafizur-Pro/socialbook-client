    ...
    <div>
      <footer className="footer p-10 bg-base-200 text-base-content">
        <div>
          ...
          <p className="text-2xl font-bold">SocialBook</p>
          <p>Providing reliable tech since 2022</p>
        </div>
        <div>
          <span className="capitalize text-lg footer-title">
            For Individuals
          </span>
        ...
        <div>
          <span className="capitalize text-lg footer-title">About</span>
        ...
        <div>
          <span className="capitalize text-lg footer-title">Contact Us</span>
